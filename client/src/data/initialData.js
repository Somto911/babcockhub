...
export const initialPosts = [
  { id: 1, author: 'Olawuyi Oluwaseun', dept: 'IT ┬╖ 300L', t: '2 min ago', cat: 'sports', txt: "PSG please ≡ƒÿ¡ the world is behind you right nowΓÇª if you lose this UCL final I'm going to be sad fr fr ≡ƒÅåΓÜ╜", likes: 0, liked: false, reposts: 0, reposted: false, repostedBy: [], imageUrl: '', comments: [
    { id: 101, author: 'Fagboy', text: 'PSG no get chance bro ≡ƒÿé', time: '1 min ago', userId: 2 },
    { id: 102, author: 'Ogunsola Dapo', text: 'Mbappe on his way to Madrid already ≡ƒÆÇ', time: 'Just now', userId: 3 },
  ] },
  { id: 2, author: 'Fagboy', dept: 'Mass Comm ┬╖ 200L', t: '1 hr ago', cat: 'sports', txt: "If Arsenal win the UCL just kill me ≡ƒÆÇ I cannot survive seeing it happen. I've suffered since 2020 and I'm not ready for this ≡ƒÿ¡Γ¥ñ∩╕Å", likes: 0, liked: false, reposts: 0, reposted: false, repostedBy: [], imageUrl: '', comments: [
    { id: 103, author: 'Olawuyi Oluwaseun', text: 'Arsenal fans been suffering since 2004 ≡ƒÿ¡', time: '55 min ago', userId: 1 },
  ] },
  { id: 3, author: 'Ogunsola Dapo', dept: 'Engineering ┬╖ 200L', t: '2 hrs ago', cat: 'gist', txt: 'The BUSA elections are looking wild ≡ƒÿé UZOMA4SPORTS really came with the energy this year. What y\'all think?', likes: 0, liked: false, reposts: 0, reposted: false, repostedBy: [], imageUrl: '', comments: [] },
  { id: 4, author: 'Osakioduwa Elisha', dept: 'Software Engineering ┬╖ 400L', t: '3 hrs ago', cat: 'hostel', txt: "ΓÜí Winslow HALL UPDATE: Power is BACK in Block C! It's been 3 days, the gen is finally fixed. Update your assignments fam ΓÇö we move!", likes: 0, liked: false, reposts: 0, reposted: false, repostedBy: [], imageUrl: '', comments: [
    { id: 104, author: 'Ememanka Chiemela', text: 'Finally! Block C residents can charge their phones again ΓÜí', time: '2 hrs ago', userId: 5 },
    { id: 105, author: 'Precious Ugo', text: 'What about Block A? Still in darkness? ≡ƒÿñ', time: '1 hr ago', userId: 7 },
  ] },
  { id: 5, author: 'Ememanka Chiemela', dept: 'Unknown ┬╖ 300L', t: '5 hrs ago', cat: 'events', txt: '≡ƒÅÑ Free medical outreach this sunday in front of Caf ! Blood pressure check, and health counselling. Bring your people! #BabcockMed', likes: 0, liked: false, reposts: 0, reposted: false, repostedBy: [], imageUrl: '', comments: [] },
  { id: 6, author: 'Emmanuel Ewedu', dept: 'Economics ┬╖ 200L', t: '6 hrs ago', cat: 'academics', txt: 'Does anyone have the Linux tutorial notes from last semester? Lecturer just announced a test for next week ≡ƒÿ░ Please help a guy out ≡ƒÖÅ', likes: 0, liked: false, reposts: 0, reposted: false, repostedBy: [], imageUrl: '', comments: [
    { id: 106, author: 'Fagboy', text: 'I have them! DM me your WhatsApp number', time: '5 hrs ago', userId: 2 },
  ] },
  { id: 7, author: 'precious ugo', dept: 'Business Admin ┬╖ 400L', t: '8 hrs ago', cat: 'academics', txt: '≡ƒÄô JUST FINISHED MY FINAL YEAR PROJECT! 4 years of stress, tears, and late nights. WE MADE IT! To every 400L student still grinding ΓÇö you\'re almost there ≡ƒÆ¬', likes: 0, liked: false, reposts: 0, reposted: false, repostedBy: [], imageUrl: 'https://images.unsplash.com/photo-1523050854058-8df90110c7f1?w=600&h=400&fit=crop', comments: [
    { id: 107, author: 'Ogunsola Dapo', text: 'Congratulations!! ≡ƒÄë Well done', time: '7 hrs ago', userId: 3 },
    { id: 108, author: 'Olawuyi Oluwaseun', text: 'Proud of you! ≡ƒÄô', time: '6 hrs ago', userId: 1 },
    { id: 109, author: 'Ememanka Chiemela', text: 'Almost there myself, this is motivation ≡ƒÖÅ', time: '6 hrs ago', userId: 5 },
  ] },
];
...
export const initialConfs = [
  { id: 1, t: '15 min ago', txt: 'I have been attending the wrong tutorial class for 3 weeks. I thought I was getting smarter ΓÇö turns out I was studying a completely different course ≡ƒÆÇ', likes: 0, liked: false },
...
export const modItems = [
  { id: 1, txt: 'Post contains targeted language against a named studentΓÇª', rep: 'Reported by 4 users', type: 'Hate Speech' },
  { id: 2, txt: 'Anonymous post may contain identifiable info about another studentΓÇª', rep: 'Auto-flagged by content filter', type: 'Privacy Concern' },
  { id: 3, txt: 'Unauthorized commercial promotion disguised as an event postΓÇª', rep: 'Reported by 2 users', type: 'Spam / Commercial' },
];
